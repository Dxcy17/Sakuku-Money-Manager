import 'package:flutter_application_1/Screens/Add_rename/Add_rename.dart';
import 'package:flutter_application_1/controllers/db_helper.dart';
import 'package:flutter_application_1/models/Transaction_model.dart';
import 'package:flutter_application_1/Screens/add_transaction/add_transaction.dart';
import 'package:flutter_application_1/widgets/confirm_dialog.dart';
import 'package:flutter/material.dart';
import 'package:flutter/rendering.dart';
import 'package:hive/hive.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:flutter_application_1/static.dart' as Static;

class Homepage extends StatefulWidget {
  static const String routeName = '/homepage'; // Add this line
...
Widget PemasukanTile(int value, String note, DateTime date, int index) {
  Size screenSize = MediaQuery.of(context).size; // Declared but not used
